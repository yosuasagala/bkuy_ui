<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="BYUK_UI.Register" %>
...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#">
      <img src="images/logo.jpeg" style="width: 130px; height: 50px; margin-top:5px; margin-bottom:5px;"> </div>
    </a>
      ...
      <div class="row" >
        ...
        <div class="col-md-5 contents offset-1" style="background-color: #FBF6F0">
          <div class="row justify-content-center" style="padding-top: 50px;">
            ...
            <div class="mb-4">
              <br>
              <h3 class="form-signin-heading" style="text-align:center;">Gabung Sekarang Juga!</h3>
            </div>
           <form id="form1" runat="server" autocomplete="off">
               ...
               <br>
              <div class="form-group first" style="border-color: #000;">
                <label style="font-size:16px;">No HP</label>
             ...
             <div class="form-group last mb-4" style="border-color: #000;">
               ...
               <asp:Button ID="btnSignUp" runat="server" Text="Sign Up" CssClass="btn btn-block btn-primary" Style="background-color: #FFDA77;color: #000;" OnClick="btnSignUp_Click" />
              <br><br>
              <p style="text-align:center; "> Sudah punya akun? <a href="Login.aspx" style="color: #FFA45B;" > Masuk disini</a></p>
              <br>
            </form>
            </div>
          </div>
